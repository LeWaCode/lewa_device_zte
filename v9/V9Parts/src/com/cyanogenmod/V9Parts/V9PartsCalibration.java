...
public class V9PartsCalibration extends Activity {
   final private static String TAG = "V9Parts";

   private View view;

   private int readValue(String parameter) {
      try {
         BufferedReader buf = new BufferedReader(new InputStreamReader(new FileInputStream(new File("/sys/module/msm_ts/parameters/tscal_" + parameter))));
   ...
   public void onCreate(Bundle savedInstanceState) {
      ...
      // Read current values
      final int xoffset = readValue("xoffset");
