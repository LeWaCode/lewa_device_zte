...
static SensorType sensorTypes[] = {
        ...
        { "5mp", 5184, 1944, true,  2592, 1944,0x00000fff }, // actual 5MP n880
        { "5mp", 2560, 1920, true,  2560, 1920,0x00000fff }, //should be 5MP n880
        { "3mp", 2064, 1544, false, 2048, 1536,0x000007ff },
        { "3mp", 4096, 1536, true, 2048, 1536,0x000007ff }, // 3MP n880
...
bool QualcommCameraHardware::native_jpeg_encode(void)
{
   ...
   char maker[PROP_VALUE_MAX];//by george,2012-02-15
   int modelLen = 0;
   
   //by george,2012-02-15
#if 0
   strncpy(maker,"ZTE",3);
   maker[3] = '\0';
#else
   __system_property_get("ro.product.manufacturer", maker);
   modelLen=strlen(maker);
   maker[modelLen] = '\0';
#endif
