...
# Bluetooth
adb pull  /system/bin/port-bridge ../../../vendor/zte/$DEVICE/proprietary/bin/port-bridge
adb pull  /system/etc/BCM4329B1_002.002.023.0735.0754.hcd ../../../vendor/zte/$DEVICE/proprietary/etc/BCM4329B1_002.002.023.0735.0754.hcd
...
adb pull /system/etc/init.qcom.coex.sh ../../../vendor/zte/$DEVICE/proprietary/etc/init.qcom.coex.sh
adb pull /system/etc/init.qcom.fm.sh ../../../vendor/zte/$DEVICE/proprietary/etc/init.qcom.fm.sh
adb pull /system/etc/init.qcom.post_boot.sh ../../../vendor/zte/$DEVICE/proprietary/etc/init.qcom.post_boot.sh
adb pull /system/etc/init.qcom.sdio.sh ../../../vendor/zte/$DEVICE/proprietary/etc/init.qcom.sdio.sh
...
# wifi
adb pull /system/bin/wpa_supplicant ../../../vendor/zte/$DEVICE/proprietary/bin/wpa_supplicant
adb pull /system/bin/wl ../../../vendor/zte/$DEVICE/proprietary/bin/wl
...
adb pull /system/bin/vold ../../../vendor/zte/$DEVICE/proprietary/bin/vold
adb pull /system/lib/liboem_rapi.so ../../../vendor/zte/$DEVICE/proprietary/lib/liboem_rapi.so
# Misc
...
adb pull /system/lib/libsensorservice.so ../../../vendor/zte/$DEVICE/proprietary/lib/libsensorservice.so
    ...
    # ril
adb pull /system/lib/libreference-ril.so ../../../vendor/zte/$DEVICE/proprietary/lib/libreference-ril.so
adb pull /system/lib/libril.so ../../../vendor/zte/$DEVICE/proprietary/lib/libril.so
adb pull /system/lib/libreference-cdma-sms.so ../../../vendor/zte/$DEVICE/proprietary/lib/libreference-cdma-sms.so
...
# Bluetooth
PRODUCT_COPY_FILES += \\
    vendor/zte/__DEVICE__/proprietary/bin/port-bridge:system/bin/port-bridge \\
    vendor/zte/__DEVICE__/proprietary/etc/BCM4329B1_002.002.023.0735.0754.hcd:system/etc/BCM4329B1_002.002.023.0735.0754.hcd \\
...
PRODUCT_COPY_FILES += \\
   ...
   vendor/zte/__DEVICE__/proprietary/lib/cm.so:system/lib/cm \\
	...
	vendor/zte/__DEVICE__/proprietary/etc/init.qcom.coex.sh:system/etc/init.qcom.coex.sh \\
    vendor/zte/__DEVICE__/proprietary/etc/init.qcom.fm.sh:system/etc/init.qcom.fm.sh \\
    vendor/zte/__DEVICE__/proprietary/etc/init.qcom.post_boot.sh:system/etc/init.qcom.post_boot.sh \\
    vendor/zte/__DEVICE__/proprietary/etc/init.qcom.sdio.sh:system/etc/init.qcom.sdio.sh \\
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/zte/__DEVICE__/proprietary/lib/liboem_rapi.so:/system/lib/liboem_rapi.so \\
    vendor/zte/__DEVICE__/proprietary/bin/vold:system/bin/vold 
...
# wifi
PRODUCT_COPY_FILES += \
    vendor/zte/__DEVICE__/proprietary/bin/wpa_supplicant:system/bin/wpa_supplicant \\
    vendor/zte/__DEVICE__/proprietary/bin/wl:system/bin/wl 	
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/zte/__DEVICE__/proprietary/lib/libsensorservice.so:system/lib/libsensorservice.so
	   ...
	   # ril
PRODUCT_COPY_FILES += \
    vendor/zte/__DEVICE__/proprietary/lib/libreference-ril.so:/system/lib/libreference-ril.so \\
    vendor/zte/__DEVICE__/proprietary/lib/libril.so:/system/lib/libril.so \\
    vendor/zte/__DEVICE__/proprietary/lib/libreference-cdma-sms.so:/system/lib/libreference-cdma-sms.so 
